...
class Tensor2Metric(shell.Task["Tensor2Metric.Outputs"]):
    ...
    mk_dirs: File | None = shell.arg(
        default=None,
        argstr="-mk_dirs",
        help="""specify the directions used to numerically calculate mean kurtosis (by default, the built-in 300 direction set is used). These should be supplied as a text file containing [ az in ] pairs for the directions.""",
    )
