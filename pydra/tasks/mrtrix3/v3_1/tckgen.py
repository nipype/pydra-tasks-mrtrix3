...
class TckGen(shell.Task["TckGen.Outputs"]):
    ...
    class Outputs(shell.Outputs):
        output_seeds: File | bool | None = shell.outarg(
            ...
            help="""output the seed location of all successful streamlines to a text file""",
        )
        output_stats: File | bool | None = shell.outarg(
            default=None,
            argstr="-output_stats",
            path_template="output_stats.txt",
            help="""output statistics on streamline generation to a JSON file""",
        )
