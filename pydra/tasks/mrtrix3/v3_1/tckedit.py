...
class TckEdit(shell.Task["TckEdit.Outputs"]):
    ...
    include: MultiInputObj[ImageIn | list[float]] | None = shell.arg(
        default=None,
        argstr="-include",
    ...
    include_ordered: MultiInputObj[ImageIn | list[float]] | None = shell.arg(
        default=None,
    ...
    exclude: MultiInputObj[ImageIn | list[float]] | None = shell.arg(
        default=None,
        argstr="-exclude",
    ...
    mask: MultiInputObj[ImageIn | list[float]] | None = shell.arg(
        default=None,
        argstr="-mask",
